...
a.是 — 如果查询返回了多行，则不能使用&#x200B;**[!UICONTROL Advanced Reporting]**，因为我们仅支持一种货币。 您必须使用[Adobe Commerce Intelligence](https://experienceleague.adobe.com/zh-hans/docs/commerce-business-intelligence/mbi/guide-overview)。 请联系您的帐户团队以进行此设置。
