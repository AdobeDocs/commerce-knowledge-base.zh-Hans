...
1. 在`.magento.env.yaml`中启用`ENABLE_EVENTING`全局变量。 [了解详情](https://experienceleague.adobe.com/zh-hans/docs/commerce-cloud-service/user-guide/configure/env/stage/variables-global)。
