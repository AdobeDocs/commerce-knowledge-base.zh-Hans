...
1. 以[Magento文件系统所有者](https://devdocs.magento.com/guides/v2.3/install-gde/prereq/file-sys-perms-over.html)的身份登录或切换到Commerce服务器。
...
要验证您的cron作业是否设置正确，请参阅我们的开发人员文档中的[设置cron作业](https://devdocs.magento.com/guides/v2.3/install-gde/install/post-install-config.html#post-install-cron)。
...
尝试手动运行每个命令，因为该命令可能会显示有用的错误消息。 请参阅我们的开发人员文档中的[设置cron作业](https://devdocs.magento.com/guides/v2.3/install-gde/install/post-install-config.html#post-install-cron)。
