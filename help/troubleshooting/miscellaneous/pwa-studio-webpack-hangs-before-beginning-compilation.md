...
* 如果使用`build`命令，它通常会为Venia生成生成工件。
* 如果使用`watch`命令，它将正常启动Venia店面。
...
* [工具和库：构建包](https://developer.adobe.com/commerce/pwa-studio/guides/project/tools-libraries/#webpack)
