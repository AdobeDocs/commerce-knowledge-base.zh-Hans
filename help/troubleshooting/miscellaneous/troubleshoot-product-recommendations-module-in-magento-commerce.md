...
1. 确认[[!UICONTROL indexers]](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/manage-indexers)（在我们的开发人员文档中）正在运行，且```php    Product Feed    ``` [!UICONTROL indexer]设置为```php    Update by Schedule    ``` 。
...
* 在[!DNL SaaS]数据导出指南中[查看日志并排除故障](https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging)
