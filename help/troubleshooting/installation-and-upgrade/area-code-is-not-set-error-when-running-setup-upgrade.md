---
title: 运行setup：upgrade时出现“未设置区号”错误
...
命令，您会收到以下错误消息： *&quot;模块&#39;Magento\_AdvancedSalesRule&#39;：正在安装数据……未设置区号：在启动会话之前必须设置区号&quot;*，命令执行已中断。 出现此问题是因为在实际设置区域配置之前请求了区域配置。 该修补程序允许捕获错误，并且不会中断升级过程。
