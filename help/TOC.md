...
* 故障排除 {#troubleshooting}
   ...
   * 安装和升级 {#installation-and-upgrade}
      ...
      * [运行安装程序:upgrade时出现未设置区号错误](/help/troubleshooting/installation-and-upgrade/area-code-is-not-set-error-when-running-setup-upgrade.md)
   ...
   * 部署 {#deployment}
      ...
      * [在部署或手动应用程序期间未找到修补程序错误](/help/troubleshooting/deployment/deployment-errors-where-patches-not-found.md)
