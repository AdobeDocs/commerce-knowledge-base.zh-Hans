...
可在开发人员文档的`robots.txt`搜索引擎机器人[文章中找到基本信息和默认Adobe Commerce ](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/seo/seo-overview#search-engine-robots)配置。
