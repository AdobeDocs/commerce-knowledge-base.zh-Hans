...
* [升级MariaDB的先决条件：在《实施行动手册》中为升级准备数据库](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/implementation-playbook/best-practices/maintenance/mariadb-upgrade#prepare-your-database-for-the-upgrade)。
