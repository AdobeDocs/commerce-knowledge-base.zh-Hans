...
ACSD-47955修补程序修复了GraphQL无法正确显示购物车折扣的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.24时，此修补程序可用。 修补程序ID为ACSD-47955。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
