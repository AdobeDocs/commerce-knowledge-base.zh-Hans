...
ACSD-53378修补程序修复了由于大量客户地址卷而导致性能问题的情况。 安装[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.40时，此修补程序可用。 修补程序ID为ACSD-53378。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
