...
MDVA-30862修补程序修复了PDF发票上打印的订单日期不正确的问题。 安装[Quality Patches Tool (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.1.6后，即可使用此修补程序。 修补程序ID为MDVA-30862。 请注意，Adobe Commerce 2.4.0中已修复此问题。
