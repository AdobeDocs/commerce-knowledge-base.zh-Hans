...
MDVA-35847修补程序解决了公司用户表单不起作用并在前端返回500错误的问题。 安装[Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.19后，即可使用此修补程序。 修补程序ID为MDVA-35847。 请注意，Adobe Commerce版本2.4.3中已修复此问题。
