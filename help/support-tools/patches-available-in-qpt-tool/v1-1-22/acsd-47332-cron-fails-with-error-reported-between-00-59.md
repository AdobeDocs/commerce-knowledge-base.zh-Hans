...
ACSD-47332修补程序修复了cron失败并出现错误的问题，该错误仅在00:00 UTC到00:59 UTC之间运行时报告。 安装[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.22时，此修补程序可用。 修补程序ID为ACSD-47332。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
