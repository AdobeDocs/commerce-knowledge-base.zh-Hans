...
ACSD-50260修补程序修复了GraphQL产品搜索结果仅限于10,000个结果的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.29时，此修补程序可用。 修补程序ID为ACSD-50260。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
