...
MDVA-37748修补程序修复了GraphQL查询返回未分配给共享目录的产品的问题。 安装[Quality Patches Tool (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.1.5时，此修补程序可用。 修补程序ID为MDVA-37748。 请注意，该问题计划在Adobe Commerce 2.4.4中修复。
