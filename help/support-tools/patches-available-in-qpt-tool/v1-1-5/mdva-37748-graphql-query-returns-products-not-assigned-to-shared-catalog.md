...
description: MDVA-37748修补程序修复了GraphQL查询返回未分配给共享目录的产品的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.5后，即可使用此修补程序。 修补程序ID为MDVA-37748。 请注意，该问题计划在Adobe Commerce 2.4.4中修复。
...
MDVA-37748修补程序修复了GraphQL查询返回未分配给共享目录的产品的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.5时，此修补程序可用。 修补程序ID为MDVA-37748。 请注意，该问题计划在Adobe Commerce 2.4.4中修复。
