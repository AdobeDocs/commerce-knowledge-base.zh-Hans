...
ACSD-46519修补程序解决了[!UICONTROL categoryList] [!DNL GraphQL]查询中的[!UICONTROL product_count]返回锚点类别为0的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.23时，此修补程序可用。 修补程序ID为ACSD-46519。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
